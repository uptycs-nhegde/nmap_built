...
LIBS =  -lnsock -lnbase libpcre/.libs/libpcre2-8.a $(LIBPCAPDIR)/libpcap.a $(LIBSSH2_LIBS) $(OPENSSL_LIBS) $(ZLIB_LIBS) libnetutil/libnetutil.a $(top_srcdir)/libdnet-stripped/src/.libs/libdnet.a $(top_srcdir)/liblua/liblua.a $(top_srcdir)/liblinear/liblinear.a -ldl 
OPENSSL_LIBS = 
LIBSSH2_LIBS = 
